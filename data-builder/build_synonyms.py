...
def build_synonyms() -> None:
    data: list[AffixSynonyms] = [
        ...
        AffixSynonyms(name = 'Arcane Casting Dexterity', synonyms = ['Lesser Arcane Casting Dexterity', 'Greater Arcane Casting Dexterity', 'reduce your Arcane Spell Failure by', 'Arcane Spell Failure']),
        ...
        AffixSynonyms(name = 'Sneak Attack Dice', synonyms = ['your Sneak Attack Dice']),
